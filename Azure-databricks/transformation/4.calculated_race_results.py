...
# since we select from several tables, it is dificult to put them in the merge statement therefore we create a temp view and use it as a source table in merge statement
spark.sql(f"""
